...
<body>
	...
	<div>
		<div class="div">
			<div><label for="choice">Reason</label>
		</div>
		<div>
	...
	<div>
		<div class="div">
			<div><label for="choice">Faculty</label>
		</div>
		<div>
	...
	<div class="right">
		...
		<table class="day">
			<tr class="box">
				<th><button name="prev">prev</button></th>
				...
				<th><button name="next">next</button></th>
			...
			<tr>
				...
				<td>
					...
					<button name ="schedule" value="<?php echo $monday . " 10:00:00" ?>"
						...
						<?php echo ($isFull || $isPastDate) ? " disabled" : '' ?>
					>	
						<?php echo (!$isFull) ? "10am - 11am" : "FULL" ?>
					</button>
					<?php
						$mondayTimeStamp = DateTime::createFromFormat('m-d-Y', $monday);
						$mondayYmd = $mondayTimeStamp->format('Y-m-d');
			...
			<tr>	
				...
				<td>
					...
					<button name ="schedule" value="<?php echo $monday . " 11:00:00" ?>"
						...
						<?php echo ($isFull || $isPastDate) ? " disabled" : '' ?>
					>	
						<?php echo (!$isFull) ? "11am - 12pm" : "FULL" ?>
					</button>
				<td>
					<?php
						$tuesdayTimeStamp = DateTime::createFromFormat('m-d-Y', $tuesday);
